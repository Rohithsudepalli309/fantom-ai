        ...
        <div className="h-full flex flex-col p-2 sm:p-4 bg-white dark:bg-slate-900/50 rounded-2xl shadow-lg">
            <header className="mb-4 flex-shrink-0 pb-3 border-b border-slate-200 dark:border-slate-700/60">
                <div className="flex items-start gap-2 flex-wrap">
                    <div>
                        <h2 className="text-2xl font-bold text-slate-800 dark:text-slate-200">Chat <span className="ml-2 px-2 py-0.5 text-[10px] font-semibold rounded bg-violet-100 dark:bg-violet-800/40 text-violet-700 dark:text-violet-300 uppercase tracking-wide">AI</span></h2>
                        <p className="text-sm text-slate-500 dark:text-slate-400 flex items-center gap-2">Have a conversation with the AI.
                            <span className="inline-block px-2 py-0.5 text-[10px] font-semibold rounded bg-violet-100 dark:bg-violet-800/40 text-violet-700 dark:text-violet-300 uppercase tracking-wide" title="Active provider">FANTOM</span>
                        </p>
                    </div>
